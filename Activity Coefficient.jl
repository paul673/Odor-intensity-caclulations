...
df = DataFrame(CSV.File("smiles_pine.csv"))
...
new_smiles
#D:\Dokumenter\Skole\Prosjektoppgave\activity_coeff\Activity Coefficient.jlget_mixture_activity_coeff(new_smiles ,new_comp)
